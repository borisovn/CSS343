...
int main() {
	...
	Poly A2, B2, Z1, Z2, D1, D2, D3, D4, A3(7, 7);
	A3.setCoeff(5, 7);
	A3.setCoeff(0, 10);

	cout << ((A3 == A) ? "A == A3" : "A is not == A3") << endl;

	D1.setCoeff(4, 5);
	D2.setCoeff(4, 5);
	cout << ((D1 == D2) ? "D1 == D2" : "D1 is not == D2") << endl;
	cout << " D: " << D1 << endl;
	cout << " D2: " << D2 << endl;
	D4 = D1 - D2;
	D3 = D1 - D2;
	cout << ((D4 == D3) ? "D4 == D3" : "D4 is not == D3") << endl;

	cout << "After:  Z1 =" << Z1 << endl << endl;
